const reviews = [
  ...
  {
    author: 'Daniel M.',
    text: 'Outstanding workmanship and prompt service. The crew went above and beyond.',
  },
  {
    author: 'Emily R.',
    text: "Friendly staff and top-notch results. Can't fault the experience.",
  },
];
    ...
    <section id="reviews" className="py-32 bg-white">
      <div className="max-w-7xl mx-auto px-10">
        ...
        <div className="mt-8 text-center">
          <a
            href="https://share.google/LpMmpg8s872XwdGbQ"
            target="_blank"
