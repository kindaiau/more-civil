export default function Footer() {
  return <footer className="bg-white text-slate-700 mt-16 border-t border-slate-200">
      <div className="max-w-7xl mx-auto px-10 py-24 grid md:grid-cols-3 gap-8">
        <div>
          <h3 className="text-slate-900 font-bold text-xl mb-3" style={{
      ...
      <div className="border-t border-slate-200 py-6 flex justify-center">
        <img src="/accreditations.png" alt="Accreditations and memberships" width="384" height="192" className="h-60 w-auto opacity-100 " />
      </div>
