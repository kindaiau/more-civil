export default function Hero() {
  return <section id="home" className="relative bg-white text-slate-900 overflow-hidden pt-20">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center px-6 py-16">
        <div className="reveal">
        ...
        }} className="font-extrabold leading-tight text-4xl md:text-5xl lg:text-6xl mx-[8px] my-[41px]">
          ...
          <div className="mt-6 inline-flex items-center gap-3 rounded-xl border border-slate-200 bg-slate-50 px-4 py-3">
        ...
        <div className="reveal">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl aspect-[16/10] bg-white flex items-center justify-center gap-4">
            ...
            <img src="/water-truck.png" alt="More Civil water truck" className="h-full w-auto object-contain" data-tilt />
